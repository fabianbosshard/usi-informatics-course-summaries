...
\subsection{Graph Traversals} \label{sec:graph-traversals}
...
Upon termination, \(\attrib{v}{distance} = \delta(s,v)\) for all \(v\in V\).
...
\end{itemize}
\end{itemize}
Observe that the gray vertices always form a linear chain of descendants corresponding to the staack of active \textsc{DFS-Visit} invocations
