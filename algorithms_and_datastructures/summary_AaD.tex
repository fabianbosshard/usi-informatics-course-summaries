...
Dynamic programming is a method for solving (typically optimization) problems by decomposing them into (slightly smaller) subproblems that share subsubproblems.
