...
\begin{algorithmic}[1]
  \Function{StronglyConnectedComponents}{$G=(V,E)$}
...
Both Algorithm \ref{alg:kruskal} and \ref{alg:prim} both run in \(O(|E|\log|V|)\) time.
