...
% Remarks :
% ▶ Differences with the second-order necessar y condition : strict ine q ualit y and the absence of the constraint q ualification condition.
% ▶ If ( x ∗ , λ ∗ ) is a KKT p oint s.t. ∇ xx 2 L ( x ∗ , λ ∗ ) ≻ 0 then x ∗ is a ( strict ) local minimiser.
% ▶ Proof of the second-order conditions in the lecture notes and in the book Cha p ter 12.
