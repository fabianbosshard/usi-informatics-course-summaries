...
\[
\begin{tikzpicture}[every node/.style={circle,draw,minimum size=3.4mm,inner sep=0pt},>=stealth, scale=0.45, font=\footnotesize]
  % layers
  \usetikzlibrary{shapes.symbols}
  \definecolor{blob}{RGB}{190,190,190}
  \tikzset{
  ...
  \draw[rounded corners=2pt] (s) 
    -- ($($(s)!0.42!(z)$) + ($(s)!0.05!90:(z)$) - (s)$)
    -- ($($(s)!0.58!(z)$) + ($(s)!0.05!270:(z)$)  - (s)$)
    -- (z);
  \draw (s)  -- ++(-0.1,-0.8);
  \draw (s)  -- ++(-1,-0.7);
