...
% after declaring theorem environments:
...
%   pdftitle={USI - Algorithms and Complexity - Course Summary},
%   pdfkeywords={USI, Algorithms and Complexity, course summary, informatics},
%   colorlinks=false,       
%   pdfborder={0.2 0.2 0.2},      % thin border
%   linkbordercolor={0 0.6 1},      % internal links
%   urlbordercolor={0 0.6 1},       % URLs
%   citebordercolor={0 0.6 1}       % citations
% ]{hyperref}

% \definecolor{hyperlinkcolor}{HTML}{0000FF}
% \usepackage[
%   pdfauthor={Fabian Bosshard},
%   pdftitle={USI - Algorithms and Complexity - Course Summary},
%   pdfkeywords={USI, Algorithms and Complexity, course summary, informatics},
%   colorlinks=true,    
%   linkcolor=hyperlinkcolor,      % internal links
%   urlcolor=hyperlinkcolor,       % URLs
%   citecolor=hyperlinkcolor       % citations
% ]{hyperref}
...
%   pdfkeywords={USI, Algorithms and Complexity, course summary, informatics},
%   colorlinks=false,       
%   pdfborder={0.1 0.1 0.1},      % thin border
%   linkbordercolor=hyperlinkcolor,      % internal links
%   urlbordercolor=hyperlinkcolor,       % URLs
%   citebordercolor=hyperlinkcolor       % citations
% ]{hyperref}
...
% BUILD MODE TOGGLE
% ======================================================
% Uncomment *one* of the two lines below depending on what you want.

% \newcommand{\buildmode}{full}    % ← compile everything (default)
\newcommand{\buildmode}{speed}   % ← only compile selected chapters

% ------------------------------------------------------
% For partial compilation, list the chapters you’re editing:
\ifx\buildmode\undefined\else
  \ifx\buildmode\speed
    \includeonly{
      chapters/05_network_flow
    }
  \fi
\fi
% ======================================================
