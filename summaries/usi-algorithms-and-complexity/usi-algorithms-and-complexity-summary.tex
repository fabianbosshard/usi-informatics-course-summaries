...
\documentclass[a4paper, fontsize=9pt, headings=standardclasses, parskip=half, titlepage, twoside]{scrartcl}
...
\definecolor{HLcyan}{HTML}{03FFFF}
\definecolor{HLpinkBase}{HTML}{FF00FF}   % neon magenta
\colorlet{HLpink}{HLpinkBase!60} 
...
\RenewDocumentCommand{\hl}{O{1} m}{%
  ...
  \IfEqCase{#1}{%
    ...
    {7}{\sethlcolor{HLcyan}\SOULhl{#2}}%
    {8}{\sethlcolor{HLpink}\SOULhl{#2}}%
...
\usepackage{tikz}
\usetikzlibrary{arrows, arrows.meta, shapes, positioning, calc, fit, patterns, intersections, math, 3d, tikzmark, decorations.pathreplacing, backgrounds, chains, svg.path, hobby, decorations.markings}
\usepackage{forest}
\usepackage{tikz-cd}
...
\makeatletter
\newcommand{\FBcleartoevenorodd}{% name irrelevant; see next macro
  \clearpage
  \if@twoside
...
% nicer name: “start next content on odd/right page”
\renewcommand{\cleardoublepage}{\FBcleartoevenorodd}
\makeatother
...
\cleardoublepage % inserts a blank page iff needed so the next page is a right/odd page
...
\href{https://search.usi.ch/courses/35275486/algorithms-complexity}{Algorithms \& Complexity} 
taught by \href{http://usi.to/i3c}{Evanthia Papadopoulou} 
in Winter 2025/2026 at the 
\href{https://www.usi.ch/en}{Università della Svizzera italiana}.
It is primarily based on the lecture slides, supplemented by \cite{%
mountCMSC451Fall2015,%
mountCMSC451Spring2025,%
kleinbergTardosAlgorithmDesign%
}.
Selected material has been adapted from 
\cite{%
mtl776Biconnected,%
chinHouckUpdatingMST,%
zwickFordFulkersonFail,%
setCoverSC,%
chakrabartyGreedySetCover,%
maxflowGoldenRatio%
}.
...
\include{chapters/00_intro_basics}
\clearpage
\include{chapters/01_stable_matching}
\clearpage
\include{chapters/02_graphs}
\clearpage
\include{chapters/03_greedy}
\clearpage
\include{chapters/04_dp}
\clearpage
\include{chapters/05_network_flow}
\clearpage
\include{chapters/06_complexity}
\clearpage

\include{chapters/90_exercises}
