...
% clickable \texttt{...} without changing its appearance
% Note: in URLs you must escape a literal # as \#
\DeclareRobustCommand{\ttlink}[2]{\href{#1}{\texttt{#2}}}
...
\begin{itemize}
  ...
  \item Bias handling in \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.nn.Linear.html}{nn.Linear}:
  ...
  \begin{itemize}
    \item A \textbf{step} is one parameter update (one batch forward/backward plus \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.optim.Optimizer.step.html}{optimizer.step()}).
  ...
  \begin{itemize}
    \item \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.optim.Optimizer.zero_grad.html}{optimizer.zero\_grad()} clears accumulated gradients.
    \item \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.optim.Optimizer.step.html}{optimizer.step()} updates parameters using the stored gradients (here, the SGD rule).
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  \item \href{https://pytorch.org/vision/stable/generated/torchvision.datasets.CIFAR10.html}{CIFAR-10}: 50k train, 10k test, RGB images of size \(3 \times 32 \times 32\), 10 classes.
...
\begin{itemize}
  ...
  \item All trainable parameters are in \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html\#torch.nn.Module.parameters}{model.parameters()} (tensors on the chosen device).
\end{itemize}
...
\begin{itemize}
  \item \ttlink{https://pytorch.org/vision/stable/generated/torchvision.transforms.RandomCrop.html}{RandomCrop(32, padding=4)} introduces small translations and zoom-like effects.
  \item \ttlink{https://pytorch.org/vision/stable/generated/torchvision.transforms.RandomHorizontalFlip.html}{RandomHorizontalFlip} encourages left--right invariance.
  \item \ttlink{https://pytorch.org/vision/stable/generated/torchvision.transforms.RandomPerspective.html}{RandomPerspective} adds mild geometric distortions.
...
\begin{itemize}
  ...
  \item \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.optim.lr_scheduler.ReduceLROnPlateau.html}{ReduceLROnPlateau} monitors validation loss and decreases the learning rate when validation performance stops improving.
...
\subsection{\ttlink{https://docs.pytorch.org/docs/stable/generated/torch.nn.Embedding.html}{nn.Embedding}}
...
\begin{itemize}
  ...
  \item Baselines include a random tour and greedy nearest-neighbor (NetworkX \ttlink{https://networkx.org/documentation/stable/reference/algorithms/generated/networkx.algorithms.approximation.traveling_salesman.greedy_tsp.html}{greedy\_tsp}).
\end{itemize}
...
\begin{itemize}
  \item As written, the approach typically does not scale directly if $n=20$ is hard-coded in \ttlink{https://docs.pytorch.org/docs/stable/generated/torch.nn.Embedding.html}{nn.Embedding(n,\dots)} or in the output head dimension.
